...
func (m *MockQuizService) AddSelection(quizID uint, selection *models.QuizSelection) error {
	m.ctrl.T.Helper()
...
func (m *MockQuizService) GetQuizzesByUserID(userID uint) ([]*models.Quiz, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuizService) UpdateQuiz(quiz *models.Quiz) error {
	m.ctrl.T.Helper()
